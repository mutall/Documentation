...
import * as merger from "../../../chama/v/test/merger.js";
...
export class merger{
    constructor(dbname:string, ename:string, members:string);
    execute(): Array<merger.intervention>;
    static intervene(input:Array<merger.intervention>):Array<merger.intervention>;
}
