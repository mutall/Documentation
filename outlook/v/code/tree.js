...
class node {
    ...
    static show_content_panel(selected) {
        // 
...
export class browser extends outlook.popup {
    ...
    async show_panels() {
        ...
        const element = html_path_node.querySelector(`div[data-id='${id}']`);
        //
    ...
    open_initial_path() {
        ...
        let path_node = node.members.get(this.initial);
        // 
